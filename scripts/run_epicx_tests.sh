#!/usr/bin/env bash
# ==== TEMPLATE: Run Epic X tests for InCollege ====
# Usage: Copy this script and change X value with current epic number. Change following paths as needed.

# This script runs Epic X tests for the InCollege program with a two-phase approach:
